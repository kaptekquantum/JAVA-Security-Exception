...
************************************************** ************************************************** **********
* Use of :
It is very simple to use, first click on the "READ" button and if you have registered sites, let them read it.
Otherwise it will already be empty.

* Adding a Site: Type the sites you want to add in the box on the right as the full address, then click the "SAVE" button.
That is all.
